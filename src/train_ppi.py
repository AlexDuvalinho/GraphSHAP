""" train_ppi.py
	...
	Trains a model on the PPI dataset
"""
...
def main_ppi(type):
    ...
    """
    # Import PPI dataset
    path = osp.join(os.path.dirname(os.path.dirname(
        os.path.realpath(__file__))), 'data', 'PPI')
